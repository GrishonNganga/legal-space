      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-48">
          ...
          <div className="mt-6">
            <div
              onClick={() => { navigate(-1) }}
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-black text-opacity-75 bg-white bg-opacity-75 sm:bg-opacity-25 sm:hover:bg-opacity-50 cursor-pointer"
            >
              Go back home
            </div>
          </div>

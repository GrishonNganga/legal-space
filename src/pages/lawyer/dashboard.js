      ...
      <div>
        ...
        <div
          className={`md:pl-64 flex flex-col flex-1 ${
            collapsedMenu && "md:pl-16 ease-in-out duration-300"
          }`}
        >
          <MiddleTopNav
            setSidebarOpen={setSidebarOpen}
            setCollapsedMenu={setCollapsedMenu}
            middleTopNavText={middleTopNavText}
          />
              ...
              <Routes>
                {
                  <>
                    <Route
                      ...
                      element={
                        <Main
                          setMiddleTopNavText={setMiddleTopNavText}
                          updateOnboardingPercentage={setOnboardingPercentage}
                        />
                      }
                    />
                    <Route
                    ...
                    <Route
                      path="/settings/*"
                      element={
                        <Settings setMiddleTopNavText={setMiddleTopNavText} />
                      }
                    />
                  </>
                }
        ...
        <div className="absolute top-0 w-full  h-full">
          <div className="w-full h-full backdrop-blur-sm flex justify-center items-center z-40">
            <Modal
              ...
              setOpen={(prevState) => {
                setProfileComplete((prevState) => !prevState);
              }}
              ui={
    ...
    <div className="w-full flex flex-col items-center gap-y-4">
      ...
      <div className="w-full md:w-1/2">
        {onboardingPercentage === 100 ? (
          <Button type="secondary" text="Completed" active={false} />
        ) : (
          <Button
            type="secondary"
            text="Complete"

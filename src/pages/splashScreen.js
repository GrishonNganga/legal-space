...
const SplashScreen = () => {
    ...
    return (
        <>
            ...
            <div className="w-full h-screen flex lg:hidden flex-col justify-between bg-legalGreen transition-opacity delay-150">
                <SplashCircles shimmer={true}/>
                <div className="flex flex-col items-center">
                    <h2 className="text-2xl font-bold tracking-tight text-legalYellow">Find the Best Lawyers</h2>
